...
export default function CommonQuestionSection() {
  return (
    <section className="section min-h-[min(960px,_100vh)] snap-start py-14 md:pb-24">
      ...
      <MotionExternalLink
        href={SIGN_UP_LINK}
        className="hover:btn-yellow focus:btn-yellow text-n6 bg-y1 text-ch-h4 rounded-card my-8 mb-6 inline-flex grow-0 py-3 px-10 font-bold tracking-wider transition-all"
