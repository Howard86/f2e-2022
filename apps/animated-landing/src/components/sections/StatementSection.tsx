  ...
  return (
    ...
    >
      <motion.div variants={BOUNCE_OUT_VARIANTS} className="svg-container h-[164px]">
        ...
        <QuestionMarkIcon
          variants={BOUNCE_OUT_VARIANTS}
          className="left-20 md:top-8 md:left-32 md:w-28"
        />
        <RectangleIcon variants={BOUNCE_OUT_VARIANTS} className="right-2 md:right-2 md:w-40 " />
        <CurlyStarIcon variants={BOUNCE_OUT_VARIANTS} className="left-4 top-2 md:w-10" />
      </motion.div>
      <motion.div variants={BOUNCE_OUT_VARIANTS} className="svg-container h-[171px]">
        ...
        <ExclamationIcon variants={BOUNCE_OUT_VARIANTS} className="right-20 top-24 md:w-36" />
        <TriangleIcon
          variants={BOUNCE_OUT_VARIANTS}
