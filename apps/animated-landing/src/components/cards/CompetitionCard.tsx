...
export default function CompetitionCard({ src, title, children }: CompetitionCardProps) {
  return (
    <article className="bg-card-background rounded-card hover:bg-decoration max-w-[485px] p-0.5 transition-all md:w-full md:hover:-translate-y-2">
      <div className="section bg-n3 rounded-card h-full px-6 py-8 md:p-10">
