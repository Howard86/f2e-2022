...
- e1981bc: Complete desktop view and remove some pre-built UI for lacking features or interactions. Consider adding rxdb for offline file persistence, nextauth for auth provider and handling session with next middleware, firebase for sharing files for multi-signature and file managers for uploaded files & signed files
...
- 7ef19bc: This will integrate all pdf features that include usage of PDF.js, html canvas, jspdf & Fabric.js
